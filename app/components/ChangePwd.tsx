...
function ChangePwd({errors, status}: {errors: {isPwdErr: boolean, pwdStrengthErr: boolean}, status: {message: string, id: string | number, ok: boolean}}) {
  return (
    <div className="max-w-sm mt-8 p-4 bg-white shadow-md rounded-md mx-auto">
    ...
    <div className="pwd-change-error-message flex flex-col">
    ...
    <div className="pwd-change-messages flex">
    {status.message || ""}
    </div>
  </Form>
    </div>
